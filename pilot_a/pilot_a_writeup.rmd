...
include_graphics("screenshots/Apriori_90.png")
include_graphics("screenshots/Apriori_95.png")
...
As noted in the "Analysis Plan" section, I am conducted a two-way ANOVA rather than a univariate MANOVA as MANOVA's are for two dependent variables typically and there is only one dependent variable.
...
```{r Main Analysis Chart, echo=FALSE}
