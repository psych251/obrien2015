...
Based on the above, there doesn't seem to need to be any corrections to the data. Thus, I created a tidy data set to be used in the confirmatory analysis:
