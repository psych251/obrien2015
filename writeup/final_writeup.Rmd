...
From this chart, we can see that the number of trials is not normally distributed and has spikes at 1 photo (minimum) and at 10 potos (the maximium), and there was a slight bump around 3 photos.

Since this is count data, let's modeling this with poisson regression (note: zero inflated poisson regression not appropriate as there are not an excess of zeroes in the non-log-transformed data set).
